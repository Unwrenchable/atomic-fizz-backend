...
async function getOrCreatePlayer(wallet) {
    ...
    if (!player) {
        player = { hp: 100, gear: [], stimpaks: [] }; // Remove caps, add stimpaks if needed
